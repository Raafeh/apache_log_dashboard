        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-600">Unique Countries</p>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-600">User Count</p>
...
export async function getStaticProps() {
  try {
    const response = await fetch('https://app.medtalk.co/logs/parsed_logs.json');
    if (!response.ok) {
    ...
    return {
      ...
      revalidate: 60, // Retry in 1 minute if failed
    };
  }
}
